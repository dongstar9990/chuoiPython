...
namespace QuanLyTienNuoc {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class KHACHHANGDataTable : global::System.Data.TypedTableBase<KHACHHANGRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public KHACHHANGRow AddKHACHHANGRow(string MaKH, string MaDH, string TenKH, string MaLoai, string DiaChi, string SDT, string GhiChu) {
        ...
        public partial class KHACHHANGRow : global::System.Data.DataRow {
            ...
            public string MaDH {
                get {
                    return ((string)(this[this.tableKHACHHANG.MaDHColumn]));
                }
                set {
                    this[this.tableKHACHHANG.MaDHColumn] = value;
                }
            }
...
namespace QuanLyTienNuoc.DataSet2TableAdapters {
    ...
    public partial class KHACHHANGTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [KHACHHANG] WHERE (([MaKH] = @Original_MaKH) AND ([MaDH] = @Original_MaDH) AND ([TenKH] = @Original_TenKH) AND ([MaLoai] = @Original_MaLoai) AND ([DiaChi] = @Original_DiaChi) AND ([SDT] = @Original_SDT) AND ((@IsNull_GhiChu = 1 AND [GhiChu] IS NULL) OR ([GhiChu] = @Original_GhiChu)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [KHACHHANG] ([MaKH], [MaDH], [TenKH], [MaLoai], [DiaChi], [SDT], [Ghi" +
                "Chu]) VALUES (@MaKH, @MaDH, @TenKH, @MaLoai, @DiaChi, @SDT, @GhiChu);\r\nSELECT Ma" +
                "KH, MaDH, TenKH, MaLoai, DiaChi, SDT, GhiChu FROM KHACHHANG WHERE (MaKH = @MaKH)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [KHACHHANG] SET [MaKH] = @MaKH, [MaDH] = @MaDH, [TenKH] = @TenKH, [MaLoai] = @MaLoai, [DiaChi] = @DiaChi, [SDT] = @SDT, [GhiChu] = @GhiChu WHERE (([MaKH] = @Original_MaKH) AND ([MaDH] = @Original_MaDH) AND ([TenKH] = @Original_TenKH) AND ([MaLoai] = @Original_MaLoai) AND ([DiaChi] = @Original_DiaChi) AND ([SDT] = @Original_SDT) AND ((@IsNull_GhiChu = 1 AND [GhiChu] IS NULL) OR ([GhiChu] = @Original_GhiChu)));
SELECT MaKH, MaDH, TenKH, MaLoai, DiaChi, SDT, GhiChu FROM KHACHHANG WHERE (MaKH = @MaKH)";
        ...
        public virtual int Delete(string Original_MaKH, string Original_MaDH, string Original_TenKH, string Original_MaLoai, string Original_DiaChi, string Original_SDT, string Original_GhiChu) {
        ...
        public virtual int Insert(string MaKH, string MaDH, string TenKH, string MaLoai, string DiaChi, string SDT, string GhiChu) {
            if ((MaKH == null)) {
        ...
        public virtual int Update(string MaKH, string MaDH, string TenKH, string MaLoai, string DiaChi, string SDT, string GhiChu, string Original_MaKH, string Original_MaDH, string Original_TenKH, string Original_MaLoai, string Original_DiaChi, string Original_SDT, string Original_GhiChu) {
            if ((MaKH == null)) {
                throw new global::System.ArgumentNullException("MaKH");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MaDH, string TenKH, string MaLoai, string DiaChi, string SDT, string GhiChu, string Original_MaKH, string Original_MaDH, string Original_TenKH, string Original_MaLoai, string Original_DiaChi, string Original_SDT, string Original_GhiChu) {
            return this.Update(Original_MaKH, MaDH, TenKH, MaLoai, DiaChi, SDT, GhiChu, Original_MaKH, Original_MaDH, Original_TenKH, Original_MaLoai, Original_DiaChi, Original_SDT, Original_GhiChu);
        }
    }
